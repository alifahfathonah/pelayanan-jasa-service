...
class Laporan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template', 'pelayanan/laporan/index', $data);
    }
    ...
    public function cetak()
    {
        ...
        $data['ket'] = $ket;
        $data['transaksi'] = $transaksi;
        $this->load->view('pelayanan/laporan/cetak', $data);
    }
    ...
    public function detail($id)
    {
        ...
        $this->template->load('template', 'pelayanan/laporan/detail', $data);
    }
    ...
    public function cetakDetail($id)
    {
        $data['sparepart'] = $this->sm->joinSparepart($id)->result_array();
        $data['surat'] = $this->sm->joinDetail($id)->row_array();
        $this->load->view('pelayanan/laporan/cetak_detail', $data);
    }
}
