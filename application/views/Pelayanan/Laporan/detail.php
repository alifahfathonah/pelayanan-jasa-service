            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <center>
                            <a href="<?= base_url('_pimpinan/laporan') ?>" class="btn btn-warning">Kembali</a>
                            <a target="_blank" href="<?= base_url('_pimpinan/laporan/cetakDetail/' . $surat['id_surat']) ?>" class="btn btn-primary"><i class="fa fa-print"></i></a>
                        </center>
                    </div>
                </div>
            </div>
