                ...
                <div class="card">
                    <div class="card-body">
                        <form method="get" action="">
                            ...
                            <a class="btn btn-warning" href="<?php echo base_url('_pimpinan/laporan'); ?>">Reset Filter</a>
                        </form>
                        <hr />
                                ...
                                if (!empty($transaksi)) {
                                    ...
                                    foreach ($transaksi as $data) { ?>
                                        <tr>
                                            <td><?= $no++ ?></td>
                                            <td>
                                                <a class="btn btn-info" href="<?= base_url('_pimpinan/laporan/detail/') . $data->id_surat ?>"><i class="fa fa-eye"></i></a>
                                            </td>
                                            <td><?= $data->id_surat ?></td>
